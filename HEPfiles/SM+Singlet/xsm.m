...
\[CurlyPhi]vev[[PosScalar[[1,2]]]] = vSM;
\[CurlyPhi]vev[[PosScalar[[2,2]]]] = vS;
\[CurlyPhi]vev
...
auxParams = {};
\[Phi]VeV3D={0,0,0,vSM,vS};  (* Note! No rescaling by Sqrt[T]. *)
className = "SSM"; (*Note! The name of a python class cannot start with a number, so 2hdm would not work.*)
indent = "    ";
printTemplate = True;
fileName = "./SSM_DRPython.py";
